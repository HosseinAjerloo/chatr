 ...
 <article class="flex items-center justify-between mb-4 flex-wrap">
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-2 w-full">
                            ...
                            <p class="font-semibold">هشدار همراه اول</p>
                        </div>
                        <p class="font-semibold">فقط 6 عدد مانده است ، لطفا شارژ کنید</p>
                    </div>
                    <div
                        class="p-3 rounded-xl space-y-1.5 w-full bg-fdf5e1 border-1 border-f79145 xl:w-[24%] sm:w-[49%] mb-2">
                        <div class="flex items-center space-x-2 w-full">
                ...
                <article class="flex items-center justify-between mb-4 flex-wrap">
                    <div
                        ...
                        <div class="font-semibold text-2xl flex items-center justify-center">
                            <p class="tracking-[20px]">60000 عدد</p>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        class="text-white p-3 rounded-xl space-y-1.5 bg-linear-100 from-079567 to-61c2a1 to-60 border-1 border-dcdde1 w-full sm:w-[49%] w-[19%] xl:w-[19%] mb-2 shadow shadow-md shadow-black/50">
                        <div class="flex items-center text-sm space-x-2 w-full">
                    ...
                    <div
                        class="text-white p-3 rounded-xl space-y-1.5 bg-linear-100 from-f36c31 to-eea75f to-60 border-1 border-dcdde1 w-full sm:w-[49%] w-[19%] xl:w-[19%] mb-2 shadow shadow-md shadow-black/50">
                        <div class="flex items-center text-sm space-x-2 w-full">
                            <img src="{{ asset('chartFront/assets/icons/Asset5.svg') }}" alt="" class="w-6" />
                            <p>موجودی همراه اول</p>
                        </div>
                        <div class="font-semibold text-2xl flex items-center justify-center">
                            <p class="tracking-[20px]">60000 عدد</p>
                        </div>
