...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/toastify-js"></script>
  ...
  <article class="bg-white p-4 rounded-lg">
                ...
                <div class="mt-4 flex items-center space-x-2">
                    ...
                    <div class="bg-dcdde1 flex items-center rounded-lg px-4 py-1.5 max-w-max space-x-2 cursor-pointer upload" data-name="phto">
                        <p class="font-semibold text-base text-012b38 ">آپلود تصویر</p>
                        <img src="../assets/images/upload.png" alt="">
                    </div>
                </div>

                <form class="mt-4 flex flex-wrap space-y-2" action="{{ route('panel.user.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <section class="flex items-center mt-2 justify-between  w-full flex-wrap xl:flex-nowrap">
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[25%] space-x-4 flex-wrap sm:flex-nowrap">
                            ...
                            <input value="{{ old('name') }}" type="text" name="name" placeholder="نام " class="w-full sm:w-[80%] md:w-[60%]   border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[30%]  space-x-4 flex-wrap sm:flex-nowrap">
                            ...
                            <input value="{{ old('family') }}" type="text" name="family" placeholder="نام خانوادگی" class="w-full sm:w-[80%] md:w-[60%]  border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[25%]  space-x-4 flex-wrap sm:flex-nowrap">
                            <label class="block  w-full sm:w-[15%] md:w-[30%] xl:w-[25%]">
                            ...
                            <input value="{{ old('username') }}" type="text" name="username" id="username" placeholder="نام کاربری" class="w-full sm:w-[80%] md:w-[60%] border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[25%]  space-x-4 flex-wrap sm:flex-nowrap">
                            <label class="block   w-full sm:w-[15%] md:w-[30%] xl:w-[25%]  ">
                            ...
                            <input value="{{ old('side') }}" type="text" name="side" placeholder="سمت " class="w-full sm:w-[80%] md:w-[60%] border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                    </section>
                    <section class="flex items-center mt-2 justify-between  w-full flex-wrap xl:flex-nowrap">
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[25%] space-x-4 flex-wrap sm:flex-nowrap">
                            ...
                            <input value="{{ old('nationality') }}"  type="text" name="nationality" placeholder="کدملی" class="w-full sm:w-[80%] md:w-[60%]   border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[30%]  space-x-4 flex-wrap sm:flex-nowrap">
                            <label class="block w-full sm:w-[15%] md:w-[30%] xl:w-[25%]  ">
                            ...
                            <input value="{{ old('phone_number') }}" type="text" name="phone_number" placeholder="شماره تماس" class="w-full sm:w-[80%] md:w-[60%]  border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                        <div class="mt-2 flex items-center w-full md:w-[49%] xl:w-[25%]  space-x-4 flex-wrap sm:flex-nowrap">
                            <label class="block   w-full sm:w-[15%] md:w-[30%] xl:w-[25%]  ">
                            ...
                            <div class=" md:w-[62%] lg:w-[60%] rounded-lg border border-dcdde1 py-1 bg-012b38 text-white px-2">
                                <select  name="city_id"   class="w-full border-none outline-none city">
                                    @foreach ($cities as $city )
                                        <option class="bg-012b38 text-white" @if (old('city_id')==$city->id) selected="selected" @endif
                           ...
                           <div class=" md:w-[62%] lg:w-[60%] rounded-lg border border-dcdde1 py-1 bg-012b38 text-white px-2">
                             <select  name="brand_id"  class="w-full border-none outline-none">
                                @foreach ($brands as $brand )
                                    <option class="bg-012b38 text-white" @if (old('brand_id')==$brand->id) selected="selected" @endif
                    ...
                    <section class="flex items-center  w-full flex-wrap xl:flex-nowrap">
                        <div class="mt-4 flex items-center space-x-4 w-full  md:w-[50%] lg:w-[25%] flex-wrap ">
                          ...
                          <div class="px-2 sm:w-[80%] md:w-[62%] lg:w-[55%] rounded-lg border border-dcdde1 py-1 bg-012b38 text-white">
                              <select name="role_id" class="w-full border-none outline-none">
                               @foreach ($roles as $role )
                                    <option class="bg-012b38 text-white" @if (old('role_id')==$role->id) selected="selected" @endif
                        ...
                        <div class="mt-4 flex items-center space-x-4 w-full  md:w-[50%] lg:w-[25%] flex-wrap">
                            ...
                            <input type="text" name="password" placeholder="رمزعبور" class="sm:w-[80%] w-full md:w-[65%] xl:w-[67%] border-dcdde1 rounded-lg px-4 py-1.5 border outline-none">
                        </div>
                    </section>
                    <section class="mt-8 flex w-full flex justify-end items-center sm:space-x-2 flex-wrap">
                            <button class="mt-4 border border-dcdde1 transition-all py-1.5 px-4 bg-2e799a font-semibold rounded-lg text-white w-full sm:w-[auto] cursor-pointer eleHover">ثبت کاربر</button>
